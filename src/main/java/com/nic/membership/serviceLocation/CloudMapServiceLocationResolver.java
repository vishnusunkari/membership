...
public class CloudMapServiceLocationResolver implements ServiceLocationResolver {
    ...
    @Value("${aws.cloudmap.service.billing}")
    private String cloudMapServiceBilling;
    ...
    public String resolve() {
        log.info("Inside CloudMapServiceLocationResolver.resolve");
        ...
        discoverInstancesRequest.setServiceName(cloudMapServiceBilling);
        ...
        log.info("Given {}, found {}", cloudMapServiceBilling + "." + cloudMapNamespace, serviceLocation);
